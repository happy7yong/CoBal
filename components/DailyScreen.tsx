      ...
      <View style={styles.dailyInner}>
        <View style={styles.innerBar}></View>
            <View style={styles.dailyContainer}>
              <Image source={require('../assets/png/Sunflower-image.png')}
              style={styles.dailyContentImage} />
              <View style={styles.rightContainer}>
                <Text style={styles.TimeText}>AM 10:00</Text>
                <Text style={styles.thinkText1}>해바라기를 선물로</Text><Text style={styles.thinkText2}>받아봤으면 했어요.</Text>
                <View style={styles.line}></View>
                <View style={styles.distance}>
                    <Image source={require('../assets/png/distance.png')}
                                  style={styles.distanceImage} />
                        <Text style={styles.GPSText}>신곡동 53-52</Text>
                </View>
                <View style={styles.btnInner}>
                    <View style={styles.soundContainer}>
                        <Image source={require('../assets/png/sound.png')}
                          style={styles.SIcon} />
                    </View>
                    <View style={styles.recorderContainer}>
                        <Image source={require('../assets/png/recorder.png')}
                          style={styles.RIcon} />
                    </View>
                 </View>
              </View>
